...
class App:
    ...
    def create_widgets(self):
        ...
        subfolder_frame = ttk.LabelFrame(self.content_frame, text="2. เลือก Sub Folder", padding="10")
    ...
    # --- FUNCTION MODIFIED TO FIX THE CLOSING ERROR ---
    def _create_scrollable_frame(self, parent, max_height):
        ...
        # 1. Store the ID of the window created on the canvas
        ...
        # 2. Use the stored ID (checkbox_frame_id) to configure the item, not the method itself
    ...
    def create_reporting_tab(self, parent_frame):
        ...
        tasks = [("รายละเอียดแต่ละ Folder", 1), ("ค้นหา Sub Folder ที่ว่างเปล่า", 2), ("สรุปประเภทไฟล์", 3)]
